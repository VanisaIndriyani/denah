                ...
                <form action="{{ route('rooms.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" 
                               ...
                               value="{{ old('name') }}" 
                               placeholder="Contoh: R. UV-VIS, R. Produksi, Lobby"
                               required>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        @error('floor_plan_id')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                        <small class="text-muted">Pilih denah tempat ruangan ini berada</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" 
                                  ...
                                  placeholder="Deskripsi atau keterangan tambahan tentang ruangan ini">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('air_quality_points', 0) }}" 
                                   min="0"
                                   placeholder="0">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="small text-muted mb-0">
                    <li>Nama ruangan harus jelas dan unik</li>
                    <li>Pilih denah yang sesuai dengan lokasi ruangan</li>
                    <li>Ruangan dapat dipilih saat menambahkan titik pengukuran</li>
                </ul>
            </div>
        </div>
    </div>
